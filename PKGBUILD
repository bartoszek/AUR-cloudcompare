...
license=('GPL2')
depends+=('cgal' 'fbx-sdk' 'ffmpeg4.4' 'glew' 'glu' 'mesa' 'mpir' 'pdal' 'laszip' 'qt5-base' 'qt5-tools' 'qt5-svg' 'qt5-websockets' 'shapelib' 'tbb' 'opencv' 'gdal')
...
# shellcheck disable=SC2191
  CMAKE_FLAGS+=(
        ...
        -DPLUGIN_STANDARD_QPCL:BOOL="$qPCL"
        ...
        -DPLUGIN_STANDARD_MASONRY_QAUTO_SEG="$qPCL"
        -DPLUGIN_STANDARD_MASONRY_QMANUAL_SEG="$qPCL"
